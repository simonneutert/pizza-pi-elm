...
var $author$project$Main$calculatePricePerCm2 = function (model) {
	var pizzaprice = function () {
		...
		if (_v0.$ === 'Just') {
			...
			if (_v1.$ === 'Just') {
				var size = _v1.a;
				return A2($author$project$Main$pricePerCm2, size, price);
			} else {
				return 0.0;
			}
		} else {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				'1 m² costs approx. ' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(pizzaprice)) + ' Euro'))
			]));
};
...
var $author$project$Main$formatFullness = function (fullnessFactorResult) {
	return (fullnessFactorResult >= 100) ? $elm$html$Html$text(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('container p-2')
			]),
		_List_fromArray(
			[
				A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Diameter in cm')
													]))
											])),
										A2(
										$elm$html$Html$div,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Price in Euro')
													]))
											])),
										A2(
										$elm$html$Html$div,
